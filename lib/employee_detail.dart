...
import 'package:pertemuan4/employee_model.dart';
import 'restapi.dart';
...
class _EmployeeDetailState extends State<EmployeeDetail> {
  ...
  selectIdEmployee(String id) async {
    List data = [];
    data = jsonDecode(await ds.selectId('6347712099b6c11c094bd757', 'office',
        'employee', '63476b4099b6c11c094bd50d', id));
  ...
  Future pickImage(String id) async {
    try {
      ...
      if (picked != null) {
        var response = await ds.upload('6347712099b6c11c094bd757', 'office',
        ...
        var updateStatus = await ds.updateId(
            'profpic',
            file['file_name'],
            '6347712099b6c11c094bd757',
            'office',
            'employee',
            '63476b4099b6c11c094bd50d',
            id);
